...
for SQL Extension State not Healthy go to :arrow_right: [Step-01-fixB-SQLExtension.md](Step-01-fixB-SQLExtension.md)<br>
for TLS related issues go to :arrow_right: [Step-01-fixC-TLS.md](Step-01-fixC-TLS.md)
